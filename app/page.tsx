  ...
  return (
    <main className="h-[100vh]">
      ...
      <div className="bottom-container bg-[#4874B4] h-[65%] flex justify-center relative">
        <div className="form-wrap bg-[#AFC8E8] w-[30%] h-fit pt-6 pb-8 flex items-center flex-col absolute top-[-10%] rounded-2xl border-4 border-white">
          <button className=" outline outline-3 outline-white rounded-xl w-[70%] my-6 bg-[#AFC8E8] font-bold text-white">
            收入
          </button>
          <button className=" outline outline-3 outline-white rounded-xl w-[70%] my-6 bg-[#AFC8E8] font-bold text-white">
            支出
